...
import io.cucumber.java.en.Given;
	...
	public class login {
		...
		@Given("user opens times india webpage")
		 public void user_opens_times_india_webpage()throws IOException
				{
		...
		{
			WebElement drp_dwn = driver.findElement(By.xpath("//*[@class='z89UZ undefined xGzbZ']"));
			Select sc = new Select(drp_dwn);
